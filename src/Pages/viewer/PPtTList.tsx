...
const PPTList = () => {
  const pptFiles = [
    { name: "Unit 1 – Introduction to IT", file: "/ppt/Unit1_IT.pptx" },
    { name: "Units 2 & 3 – Book 1", file: "/ppt/Units2&3_Book1.pptx" },
    { name: "Unit 4 – Book 1", file: "/ppt/Units4_Book1.pptx" },
    { name: "Units 5 & 6 – Book 1", file: "/ppt/Units5&6_Book1.pptx" },
    { name: "Units 7 & 8 – Part 1", file: "/ppt/Units7and8_Part1.pptx" },
    { name: "Units 9 & 10 – Book 1", file: "/ppt/Units9&10_Book1.pptx" },
    { name: "Units 11 & 12 – Book 1", file: "/ppt/Units11&12_Book1.pptx" },
    { name: "Units 13 & 14 – Book 1", file: "/ppt/Units13&14_Book1.pptx" },
    { name: "Units 15 & 16 – Book 1", file: "/ppt/Units15&16_Book1.pptx" },
  ];
