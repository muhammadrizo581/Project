        ...
        {!finished ? (
            ...
            <div className="grid grid-cols-1 gap-3 mb-6">
              {questions[current].options.map((opt, i) => (
                <button
                  ...
                  className="bg-gray-200 hover:bg-blue-100 text-gray-800 px-4 py-3 rounded-lg shadow transition text-left"
                >
                  {opt}
                </button>
              ))}
          ...
          <div className="text-center">
            ...
            <button
              ...
              className="mt-6 bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg shadow"
            >
              Go to Game 2 ➡️
            </button>
          </div>
